	...
	return (
		<div className="col-span-6 space-y-2 rounded-2xl bg-mainblue p-6 dark:bg-mainblue md:col-span-4">
			...
			<p>
				...
				<br />I mostly do frontend stuff but I'm highly interested and work with backend as well.
			</p>
			<p>
				Film nerd.
				<br />
				...
				<br />
				<p>If you need a software expert who can also recommend a movie - contact me.</p>
			</p>
		</div>
	);
};
